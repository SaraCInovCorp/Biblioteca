...
<x-app-layout>
    ...
    <div class="flex-1 ">
            ...
            <form method="POST" action="{{ route('livros.store') }}" enctype="multipart/form-data" class="mx-auto p-6">
                @csrf
                <div class="mb-4 col-span-1 lg:col-span-2">
                    ...
                    <div class="flex gap-2">
                        ...
                        <x-button type="button" id="btn-pesquisar-google">Pesquisar</x-button>
    ...
    <script>
        ...
        document.getElementById('btn-limpar-pesquisa').addEventListener('click', () => {
            ...
            document.getElementById('pesquisa_google').value = ''; 
        });
